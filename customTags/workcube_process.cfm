...
<cfparam name="attributes.data_source" default="#catalyst_prod#">
...
<cfelseif attributes.is_upd eq 1>
	...
	<cfif get_Process_Type_1.Line_Number neq attributes.Old_Process_Line>
		...
		<cfif 1 eq 1><!--- eger agacli yapi var ise buna bagli olarak kisi izinde iken onun onaylari yedegine duser --->
