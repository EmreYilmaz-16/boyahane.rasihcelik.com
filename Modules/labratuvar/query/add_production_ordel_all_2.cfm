...
<cfquery name="getToplamsure" datasource="#dsn#_1">
select sum(ot.O_MINUTE) AS OP_TOPLAM from catalyst_prod_1.PRODUCT_TREE as pt 
left join catalyst_prod_1.OPERATION_TYPES as ot on ot.OPERATION_TYPE_ID=pt.OPERATION_TYPE_ID
where pt.STOCK_ID =(Select STOCK_ID from catalyst_prod_1.ORDER_ROW where ORDER_ROW_ID=82)
</cfquery>


<cfset emreTarih=createodbcdatetime(emreTarih)>

<cfif len(getToplamsure.OP_TOPLAM)>
<cfset tsurem=getToplamsure.OP_TOPLAM>
<cfelse>
<cfset tsurem=30>
</cfif>
