...
<cflock name="#CREATEUUID()#" timeout="20">
	<cftransaction>
		<cfloop query="get_ship">
			<cfquery name="ADD_SHIP_HISTORY" datasource="#New_DSN_2#" result="MAX_ID">
				INSERT INTO
					SHIP_HISTORY
				(
					SHIP_ID,
		...
		<cfloop query="get_ship_row">
			<cfquery name="ADD_SHIP_ROW_HISTORY" datasource="#New_DSN_2#">
				INSERT INTO
					SHIP_ROW_HISTORY
				(
					SHIP_HISTORY_ID,
