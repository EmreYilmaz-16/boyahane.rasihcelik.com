<cfquery name="get_rows_stocks" datasource="#New_DSN_2#">
	SELECT
		SHIP_ROW.AMOUNT,
		SHIP_ROW.TAX,
		SHIP_ROW.STOCK_ID,
...
<cfif len(get_rows_stocks.SUBSCRIPTION_ID)>
	...
	<cfquery name="get_inv_stock" datasource="#New_DSN_2#">
	...
	<cfif get_inv_stock.recordcount>
		...
		<cfquery name="DEL_SHIP_ROW_MONEY" datasource="#New_DSN_2#">
		...
		<cfquery name="DEL_INVENTORY_ROW" datasource="#New_DSN_2#">
			DELETE FROM #dsn3_alias#.INVENTORY_ROW WHERE ACTION_ID IN(#valuelist(get_inv_stock.fis_id)#) AND PROCESS_TYPE = 1182 AND PERIOD_ID = #New_Period_Id#
		</cfquery>
	</cfif>
	...
	<cfif get_rows_stocks.recordcount>
		<cfquery name="GET_MONEY_INFO" datasource="#New_DSN_2#">
			SELECT * FROM SHIP_MONEY WHERE ACTION_ID = #row_ship_id#
		</cfquery>
		<cfquery name="GET_BRANCH" datasource="#New_DSN_2#">
			SELECT * FROM #dsn_alias#.DEPARTMENT WHERE DEPARTMENT_ID = #get_rows_stocks.DEPARTMENT_IN#
		</cfquery>
		<cfquery name="get_gen_paper_" datasource="#New_DSN_2#">
		...
		<cfloop query="get_rows_stocks">
            ...
            <cfif kalan_miktar_ gt 0>
                ...
                <cfquery name="get_periods" datasource="#New_DSN_2#">
                    SELECT * FROM #dsn_alias#.SETUP_PERIOD WHERE OUR_COMPANY_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.ep.company_id#"> 
					ORDER BY PERIOD_YEAR DESC	<!--- AND PERIOD_YEAR <= #session.ep.period_year# gecmise donuk stok iade fisi olusturabilmek icin yil kontolu kaldirildi 20140715 EsraNur --->
                </cfquery>					
                <cfquery name="get_system_inventory" datasource="#New_DSN_2#">
                    SELECT
