...
<cfset DSN2 = attributes.kayit_area>;
<cfset DSN2_ALIAS = attributes.kayit_area>;
		...
		<cfif isDefined("session.ep")><!--- pda den gelen kayıtlar için --->
			...
			<cfelseif isdefined("attributes.process_stage")>
				<cf_workcube_process
					...
					warning_description='Sipariş : #form.order_id#'>	
			</cfif>
...
<div class="alert alert-success">Renk Tanımlanmıştır <a style="margin-left:15px" onclick="HideTModal()" class="btn btn-success">Tamam</a></div>
<script>
function HideTModal(){
