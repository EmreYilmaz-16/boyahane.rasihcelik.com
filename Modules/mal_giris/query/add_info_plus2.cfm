<cfif not isdefined("new_dsn2_group")><cfset new_dsn2_group = New_DSN_2></cfif>
...
<cfif not isdefined("new_dsn2_group_alias")><cfset new_dsn2_group_alias = New_DSN_2></cfif>
...
<cfquery name="get_our_company_info" datasource="#dsn_adi#">
	...
	<cfif listfind('-1,-2,-3,-4,-10,-13,-19,-20,-15,-17,-21,-23,-27', attributes.info_type_id,',')>
		<cfset SELECT_TABLO_ADI ="#dsn#.SETUP_INFOPLUS_VALUES">
		<cfset PRO_TABLO_ADI="#dsn#.SETUP_INFOPLUS_NAMES">
		<cfset ALAN1 ="INFO_ID">
	<cfelse>
