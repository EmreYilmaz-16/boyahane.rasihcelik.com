...
<cfset EMRE_URUN_AYDI=GET_PID.PRODUCT_ID>
...
<cfquery name="ADD_STOCKS" datasource="#dsn1#">
	...
	(
		...
		MANUFACT_CODE,
		STOCK_CODE_2,
		RECORD_EMP, RECORD_IP, RECORD_DATE,IS_MAIN_STOCK
	)
	VALUES
	(
		'#attributes.PRODUCT_CODE#',
		...
		'Renksiz',
		#session.ep.userid#, '#REMOTE_ADDR#', #now()#,1
	)
</cfquery>
