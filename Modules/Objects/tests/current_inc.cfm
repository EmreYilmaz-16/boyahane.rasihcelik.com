            <cfset attributes.DELIVER_DATE_1="#dateformat(data.ev.startDate,'yyyy-mm-dd')#">
            ...
            <cfset attributes.START_DATE_1="#dateformat(data.ev.startDate,'yyyy-mm-dd')#">
<cfset attributes.station_id_1_0="#data.ev.groups.STATION_ID#,0,0,0,-1,4,4,4,4">
<cfoutput>
<CFSET START_DATE=dateAdd("h", 2, data.ev.startDate)>
